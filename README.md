...
- [X] [Valid Palindrome II](https://leetcode.com/problems/valid-palindrome-ii/solutions/1861656/official-solution/)
...
- [X] [Maximize Capital](https://leetcode.com/problems/ipo/) (H)

- [ ] [Sliding Window Median](https://leetcode.com/problems/sliding-window-median/) (H)

- [X] [Find Median from a Data Stream](https://leetcode.com/problems/find-median-from-data-stream/) (H)
...
- [ ] [Kth Smallest Number in M Sorted Lists](https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix/)? (not available)

- [X] [Find K Pairs with Smallest Sums](https://leetcode.com/problems/find-k-pairs-with-smallest-sums/)

- [X] [Merge K Sorted Lists](https://leetcode.com/problems/merge-k-sorted-lists/) (H)
...
- [ ] [Alien Dictionary](https://leetcode.com/problems/alien-dictionary/) (H)
...
- [ ] [Connect All Siblings of a Binary Tree](https://leetcode.com/problems/populating-next-right-pointers-in-each-node/) (not available)
